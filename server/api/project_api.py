...
class ProjectApi:
    ...
    def __init__(self):
        ...
        self.bp_project.route('/<int:project_id>',
                              methods=['GET'],  endpoint="get_project_by_id")(self.get_project_by_id)
        self.bp_project.route('/<int:project_id>',
                              methods=['PUT'],  endpoint="update_project")(jwt_required()(self.update_project))
        self.bp_project.route(
            '/<int:project_id>', methods=['DELETE'], endpoint="delete_project")(jwt_required()(self.delete_project))
